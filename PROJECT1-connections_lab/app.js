...
function updatePageInfo(warList) {
    ...
    // //DATA ESTIMATED AFFECTED CODE

    // //create element for estimated_affected  
    // let affectedElement = document.createElement('h2');
    // affectedElement.classList.add('estimated-text');
    // affectedElement.innerText = randomWar.estimated_affected ;

    // // //create element for conflict description
    // // let affectedElement= document.createElement('p');
    // // affectedElement .innerText = randomWar.estimated_affected;

    // //add name + description to the page
    // let affectedContainer = document.getElementById('description-container');
    // //clear out any current info
    // affectedContainer.innerHTML = "";
    // //append both elements inside the container
    // affectedContainer.appendChild(affectedElement);
